...
ACTIONS = [  # (slug, title, icon, keywords, body)
 ("settings", "All Settings", "⚙️", ["settings","system settings","preferences","control center","gnome settings"], "launch gnome-control-center"),
 ...
 ("extensions", "Extensions", "🧩", ["extensions","gnome extensions","extension manager","shell extensions"], "launch gnome-extensions-app"),
...
for panel, title, icon, kw, in PANELS:
    write("settings-" + panel, title, icon, kw + ["settings"], "Settings", f"launch gnome-control-center {panel}")
